...
public enum ModArmorMaterials implements ArmorMaterial {
    BAGEL("bagel", 26, new int[]{ 10, 12, 10, 9}, 25, SoundEvents.ARMOR_EQUIP_TURTLE,
            10f, 2f, () -> Ingredient.of(ModItems.BAGELSTAR.get()));
    ...
    private static final int[] BASE_DURABILITY = {16, 21, 21, 18};
    ...
    public String getName() {
        return BagelSiege.MODID + ":" + this.name;
    }
